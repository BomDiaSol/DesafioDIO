...
public class Bootcamp {
    ...
    public int hashCode() {
        ...
        result = prime * result + ((devsInsctritos == null) ? 0 : devsInsctritos.hashCode());
    ...
    public boolean equals(Object obj) {
        ...
        if (dataFinal == null) {
            ...
            return false;
        if (devsInsctritos == null) {
            if (other.devsInsctritos != null)
                return false;
        } else if (!devsInsctritos.equals(other.devsInsctritos))
            return false;
        if (conteudos == null) {
